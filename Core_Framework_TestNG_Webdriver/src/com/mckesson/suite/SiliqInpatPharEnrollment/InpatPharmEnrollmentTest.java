...
public class InpatPharmEnrollmentTest extends TestSuiteBase {
	...
	public void checkTestSkip(){
		...
		if(!TestUtil.isTestCaseRunnable(suite_SiliqInpatPharmacyEnrollment__xls,this.getClass().getSimpleName())){
			APP_LOGS.debug("Skipping Test Case "+this.getClass().getSimpleName()+" as runmode set to NO");//logs
			throw new SkipException("Skipping Test Case "+this.getClass().getSimpleName()+" as runmode set to NO");//reports
		}
		// load the runmodes off the tests
		runmodes=TestUtil.getDataSetRunmodes(suite_SiliqInpatPharmacyEnrollment__xls, this.getClass().getSimpleName());
	}
	...
	public Object[][] getTestDatasiliq(){
		...
		return TestUtil.getData(suite_SiliqInpatPharmacyEnrollment__xls, this.getClass().getSimpleName());
	}

	@AfterMethod
	public void reportDataSetResult(){
		if(skip)
			TestUtil.reportDataSetResult(suite_SiliqInpatPharmacyEnrollment__xls, this.getClass().getSimpleName(), count+2, "SKIP");
		else if(fail){
			isTestPass=false;
			TestUtil.reportDataSetResult(suite_SiliqInpatPharmacyEnrollment__xls, this.getClass().getSimpleName(), count+2, "FAIL");
		}
		else
			TestUtil.reportDataSetResult(suite_SiliqInpatPharmacyEnrollment__xls, this.getClass().getSimpleName(), count+2, "PASS");
	...
	public void reportTestResult(){
		if(isTestPass)
			TestUtil.reportDataSetResult(suite_SiliqInpatPharmacyEnrollment__xls, "Test Cases", TestUtil.getRowNum(suite_SiliqInpatPharmacyEnrollment__xls,this.getClass().getSimpleName()), "PASS");
		else
			TestUtil.reportDataSetResult(suite_SiliqInpatPharmacyEnrollment__xls, "Test Cases", TestUtil.getRowNum(suite_SiliqInpatPharmacyEnrollment__xls,this.getClass().getSimpleName()), "FAIL");
